...
const Login = () => {
  ...
  // Menggunakan komponen <Navigate> karena kita sedang berada di dalam fase render React
  if (isAuthenticated) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect ke halaman asal (jika ada) atau biarkan AuthContext auto-route berdasarkan role
      // login() function di AuthContext sudah melakukan navigate() berdasarkan role secara otomatis
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-secondary-50 relative">
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <span className="text-xs text-center text-secondary-500 uppercase">Atau masuk dengan</span>
            <span className="w-1/5 border-b border-secondary-300 lg:w-1/4"></span>
          </div>
          ...
          <button
            type="button"
            className="mt-6 w-full flex items-center justify-center gap-3 py-3 px-6 bg-white border border-secondary-300 rounded-xl
                       text-secondary-700 font-semibold hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-secondary-200
