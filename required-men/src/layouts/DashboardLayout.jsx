      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-white border-b border-secondary-200 flex items-center justify-between px-6 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-2">
            ...
            <NavLink to="/" className="flex items-center gap-2 px-3 py-2 text-sm text-secondary-600 hover:bg-secondary-100 rounded-lg transition-colors">
